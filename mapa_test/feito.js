...
MarkerLabel_.prototype.onRemove = function () {
  ...
  for (i = 0; i < this.listeners_.length; i++) {
    google.maps.event.removeListener(this.listeners_i]);
  }
};
...
MarkerLabel_.prototype.setStyles = function () {
  ...
  for (i in labelStyle) {
    if (labelStyle.hasOwnProperty(i)) {
      this.labelDiv_.stylei] = labelStylei];
      this.eventDiv_.stylei] = labelStylei];
    }
  }
...
function initMap() {
     ...
     var marker1 = new MarkerWithLabel({
       ...
       raiseOnDrag: true,
       map: map,
       labelContent: "Olha o label aqui",
